...
[Cleanaway][website_link] provides the most complete range of sustainable total waste management services to fit all events, business needs, regulations and scenarios.

This project focuses on scraping all the service locations across Australia and their associated attributes from [Cleanaway][website_link], performing exploratory data analysis to generate insights and visualize them with the help of Power BI.

The repository directory structure is as follows:

Analyzing-Cleanway-Services<br>
├─ 01_WEBSCRAPING<br>
├─ 02_ETL<br>
├─ 03_DATA<br>
├─ 04_ANALYSIS<br>
...
[website_link]: https://www.cleanaway.com.au/
